...
export default function Home() {
  return (
    <main>
      <Navbar />
      <div>
        <div className="flex items-start  w-full h-screen bg-gradient-to-b from-blue-800 to-red-700 text-white">
          <div
        ...
        <div className="w-full h-auto rounded-b-[100vw] bg-red-700 flex flex-col justify-center items-center py-20 px-6">
